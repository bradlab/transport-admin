 ...
 */
@Dependent
public class PermissionUtilisateurDao extends AdminDaoImpl<PermissionUtilisateur, PermissionUtilisateurPK> implements Dao<PermissionUtilisateur, PermissionUtilisateurPK> {
